# Find number of packages with "-" instead of "_" in name
...
class GithubReadme:
    ...
    def __init__(self):
        ...
        self.elapsed_time = 0
        self.repo_count_with_underscore = 0

    def append_readme(self, req, repo):

        if "_" in repo:
            repo = repo.replace("_", "-")
            self.repo_count_with_underscore += 1
    ...
    def calculate_stats(self):
        ...
        self.stats['Repos-Count-With-Underscore'] = self.repo_count_with_underscore
...
def main():
    ...
    Load1.JsonSaver(dictfile=readme_extract.stats,
                    ...
                    filename="stats_repos_with_underscore_1.json")
